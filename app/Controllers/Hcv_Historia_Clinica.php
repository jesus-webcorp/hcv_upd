...
class Hcv_Historia_Clinica extends BaseController
{
    public function index() {
        ...
        //Vars
        $data_header['title'] = "HISTORIA CLINÍCA";
        $data_header['description'] = "Ingresar historia cliníca del paciente";
        $model = model('App\Models\groups_models\Crud_group_model');
        $data_left['menu'] = get_menu();
        echo view('header' , $data_header);
		echo view('left_panel',$data_left);
        echo view('head_panel');
		echo view('hcv/historia_clinica');
