...
class Hcv_Nota_Medica extends BaseController
{
    public function index() {
        ...
        //Vars
        $data_header['title'] = "NOTA MÉDICA";
        $data_header['description'] = "Ingresar nota médica del paciente";
        $model = model('App\Models\groups_models\Crud_group_model');
        $data_left['menu'] = get_menu();
        echo view('header' , $data_header);
		echo view('left_panel',$data_left);
        echo view('head_panel');
		echo view('hcv/nota_medica');
